...
def main() -> None:
    ...
    st.caption(
        ...
        "The AI calculates your calorie needs and creates a balanced weekly plan."
    )
    ...
    if "weekly_plan" in st.session_state and st.session_state["weekly_plan"]:
        ...
        if "plan_summary" in st.session_state:
            ...
            with st.expander("📝 AI Plan Summary", expanded=False):
                st.markdown(summary)
            st.download_button(
                "Download Plan",
                data=summary,
        ...
        st.markdown(
            """
            Our agent calculates your calorie needs using:
            ...
            Then it creates a balanced meal plan that hits your targets.
            """
        )
